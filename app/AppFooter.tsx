...
const navigation: NavigationItem[] = [
    {
        ...
        icon: props => (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72.54 78.82" {...props} fill="currentColor">
                <defs>
                    <style>
                        {
                ...
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        ...
                        <polygon className="cls-3" points="11.74 49.66 29.31 53.26 29.31 48.16 11.74 46 11.74 49.66"/>
                        <polygon className="cls-1"
...
export default function AppFooter() {
    return (
        <footer className="bg-white dark:bg-pale-800">
